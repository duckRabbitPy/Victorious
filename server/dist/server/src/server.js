...
const createWebsocketServer_1 = require("./websocketServer/createWebsocketServer");
const createHttpServer_1 = require("./httpServer/createHttpServer");
...
(0, createHttpServer_1.createHttpServer)(appWithWSSUpgrade);
(0, createWebsocketServer_1.createWebsocketServer)(appWithWSSUpgrade);
