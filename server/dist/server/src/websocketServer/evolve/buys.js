...
exports.gainCard = exports.buyCard = exports.resetBuysAndActions = void 0;
...
const buyCard = ({ gameState, userId, cardName, toDiscardFromHand, }) => {
    ...
    if ((0, common_1.getTreasureValue)((0, common_1.sumCardCounts)((0, common_1.cardNamesToCount)(toDiscardFromHand), gameState.actor_state.filter((a) => a.id === userId)[0].cardsInPlay)) +
        gameState.actor_state.filter((a) => a.id === userId)[0]
            .bonusTreasureValue <
        (0, common_1.cardNameToCard)(cardName).cost) {
        return effect_1.Effect.fail(new customErrors_1.IllegalGameStateError({
...
const gainCard = ({ gameState, userId, cardName, }) => {
    if (gameState.global_state.supply[cardName] < 1) {
        return effect_1.Effect.fail(new customErrors_1.IllegalGameStateError({
    ...
    const newActorState = gameState.actor_state.map((actor) => {
        if (actor.id === userId) {
            const currentActorDemandPhase = actor.actionPhaseDemand;
            const endActionDemandPhase = (currentActorDemandPhase === null || currentActorDemandPhase === void 0 ? void 0 : currentActorDemandPhase.count) === null || 1 || 0;
            const newActionPhaseDemand = endActionDemandPhase
                ? null
                : Object.assign(Object.assign({}, currentActorDemandPhase), { count: ((currentActorDemandPhase === null || currentActorDemandPhase === void 0 ? void 0 : currentActorDemandPhase.count) || 1) - 1 });
            const newHand = Object.assign(Object.assign({}, actor.hand), { [cardName]: actor.hand[cardName] + 1 });
            return Object.assign(Object.assign({}, actor), { hand: newHand, phase: (0, common_1.hasActionCard)(newHand) && actor.actions > 0
                    ? common_1.Phases.Action
                    : common_1.Phases.Buy, actionPhaseDemand: newActionPhaseDemand });
        }
        return actor;
    });
    const latestTransaction = `${gameState.actor_state.filter((a) => a.id === userId)[0].name} gained ${(0, utils_1.indefiniteArticle)(cardName)} ${cardName}`;
    const newGlobalState = Object.assign(Object.assign({}, gameState.global_state), { supply: Object.assign(Object.assign({}, gameState.global_state.supply), { [cardName]: gameState.global_state.supply[cardName] - 1 }), history: [...gameState.global_state.history, latestTransaction] });
    return effect_1.Effect.succeed(Object.assign(Object.assign({}, gameState), { actor_state: newActorState, global_state: newGlobalState }));
};
exports.gainCard = gainCard;
